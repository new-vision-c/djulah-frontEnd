    ...
    return Scaffold(
      ...
      body: GestureDetector(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            // Header collapsible avec logo et titre
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SecondaryButton(
                          ...
                          fontWeight: FontWeight.w500,
                          onPressed: () async {
                            Get.toNamed(RouteNames.clientForgetPassword);
                          },
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 5.r),
                            GestureDetector(
                              onTap: () => Get.toNamed(RouteNames.clientInscription),
                              child: Text(
                                'auth.signUp'.tr,
                                style: TextStyle(
                                  color: ClientTheme.primaryColor,
                        ...
                        SizedBox(height: 28.r + MediaQuery.of(context).viewInsets.bottom),
                      ],
                    ),
                  );
                }),
