...
import 'controllers/utilisation_donnees.controller.dart';

class UtilisationDonneesScreen extends GetView<UtilisationDonneesController> {
  const UtilisationDonneesScreen({super.key});
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        child: Column(
          children: [
            AppBarCustom(title: "Utilisation des données"),
            Expanded(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SecondaryButton(
                        ...
                        fontSize: 16.sp,
                        isEnabled: true,
                        icon: Image.asset("assets/images/client/profil_icons/download.png", color: ClientTheme.primaryColor,),
                        textColor: ClientTheme.primaryColor,
